...
<body>
	...
	<header>
		<div class="header-content">
			...
			<div class="jumbotron jumbotron-fluid jumbotron-concierge">
				<div class="container">
					<h1 class="display-3 display-concierge"><?= get_post_meta( $post->ID, 'rep_title', $single=true ) ?></h1>
					<div class="row"> 
						<div class="col-lg-6 offset-lg-3">
							<h4 class="lead-concierge">Looking for something?</h4>
							<hr />
						</div>
					</div>
					<div class="row"> 
						<div class="col-lg-6 offset-lg-3">
							<div class="text-center" id="services-search">								
								<div class="input-group">
									<input id="url" type="text" class="form-control form-control-lg" placeholder="Search Student Services">
									<span class="input-group-btn">
										<button onclick="search()" class="btn btn-concierge" type="button" ><i class="fa fa-search"><span class="sr-only">Search</span></i></button>
									</span>
								</div>								
							</div>
						</div>
